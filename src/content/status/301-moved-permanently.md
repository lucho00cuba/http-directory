...
updated: "2026-08-02"
created: "2026-08-02"
referenceUrl: "https://httpguides.com/status/301-moved-permanently"
---
...
If you want to be sure that the request will be retried with the same method and body, use [`308 Permanent Redirect`](../308-permanent-redirect).

| Request Method                |            Permanent             |            Temporary             |
| ----------------------------- | :------------------------------: | :------------------------------: |
| Can change from POST to GET   |               301                |       [302](../302-found)        |
