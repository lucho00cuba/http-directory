...
updated: "2026-08-02"
created: "2026-08-02"
referenceUrl: "https://httpguides.com/status/422-unprocessable-entity"
---
...
If the client sends you a malformed or invalid JSON, you should return the [`400 Bad Request`](../400-bad-request). If the JSON itself is valid, but some fields aren't, you should respond with `422 Unprocessable Entity`.
