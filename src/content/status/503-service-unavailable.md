...
updated: "2026-08-02"
created: "2026-08-02"
referenceUrl: "https://httpguides.com/status/503-service-unavailable"
---
...
Websites might also use this status code to block automated scraping. In such instances, it's advisable to change the `User-Agent` header to a string that resembles a browser and throttle requests. Also, check the <a href="../../robots.txt">robots.txt</a> directives to make sure you're abiding by them.
