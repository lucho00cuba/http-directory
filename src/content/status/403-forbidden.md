...
updated: "2026-08-02"
created: "2026-08-02"
referenceUrl: "https://httpguides.com/status/403-forbidden"
---
...
For example, if you have been assigned a read-only "Visitor" role in the web app, trying to change a password would trigger the [`403 Forbidden`](../403-forbidden) response from the server.
