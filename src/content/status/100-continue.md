...
referenceUrl: "https://httpguides.com/status/100-continue"
---
...
`100 Continue` is an informational status code, and in most cases, you won't have to deal with it directly. [Informational status codes (`1xx`)](../../#1xx) are temporary and should not be treated as final responses.
