...
updated: "2026-08-02"
created: "2026-08-02"
referenceUrl: "https://httpguides.com/status/409-conflict"
---
...
- if the request body (payload) is valid but semantically incorrect, stick to [`422 Unprocessable Entity`](../422-unprocessable-entity)
- if the request body (payload) is invalid, use [`400 Bad Request`](../400-bad-request)
