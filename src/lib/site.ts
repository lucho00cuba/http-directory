...
export const site = {
  ...
  origin: "https://lucho00cuba.github.io",
  /** Repository path used by GitHub Pages (must match astro.config `base`) */
  base: "/http-directory",
  /** Public site URL, including the GitHub Pages repository path */
  url: "https://lucho00cuba.github.io/http-directory/",
  locale: "en_US",
  language: "en",
